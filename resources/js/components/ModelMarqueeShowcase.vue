        ...
        <div class="relative z-10 mx-auto max-w-7xl px-5 sm:px-8">
            <div class="relative mx-auto max-w-6xl overflow-hidden">
                ...
                <div class="model-marquee flex w-max items-center gap-10 py-2">
                    <div
                        ...
                        :key="`${logo}-${index}`"
                        class="model-showcase-logo flex min-w-max items-center gap-3 text-xl font-extrabold tracking-normal text-brand-neutral-900/72 sm:text-2xl"
                        aria-hidden="true"
                    >
                        <span
            ...
            >
                <article
                    ...
                    "
                    :class="[
                        'model-showcase-card group relative h-96 w-68 shrink-0 overflow-hidden rounded-3xl border border-brand-neutral-900 bg-brand-neutral-900 bg-cover bg-center text-white shadow-[5px_5px_0_0_var(--color-brand-neutral-900)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[7px_7px_0_0_var(--color-brand-neutral-900)]',
                        item.frameClass,
                        item.offsetClass,
                    ]"
                >
